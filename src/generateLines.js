...
const _generateDepthStr = (areAncestorsLastChildren) => {
...
const generateFileLine = ({ file, isLastChild, areAncestorsLastChildren }) => {
  ...
  const depthStr = _generateDepthStr(areAncestorsLastChildren);
...
const generateDirLine = ({ isLastItem, key, areAncestorsLastChildren }) => {
  ...
  const dirDepthStr = _generateDepthStr(areAncestorsLastChildren);
